...
ESX.SavePlayer = function(xPlayer, cb)
	...
	Async.parallel(asyncTasks, function(results)
		RconPrint('^0[^1Kayıt Oldu^0] ' .. xPlayer.name .. "^7\n")
...
ESX.SavePlayers = function(cb)
	...
	Async.parallelLimit(asyncTasks, 8, function(results)
		RconPrint('^1[Kayıt Oldu]^0 Tum Oyuncular' .. "\n")
...
ESX.StartDBSync = function()
	function kayitData()  --saveData  -- kayitData Değiştirildi.
		ESX.SavePlayers()
		SetTimeout(10 * 60 * 1000, kayitData)
	end
