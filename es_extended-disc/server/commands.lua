TriggerEvent('es:addGroupCommand', 'tp', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Yetersiz yetkiler.' } })
end, {help = 'Teleport to coordinates', params = {{name = 'x', help = 'X coords'}, {name = 'y', help = 'Y coords'}, {name = 'z', help = 'Z coords'}}})

TriggerEvent('es:addGroupCommand', 'meslekver', 'admin', function(source, args, user)
...
--]]
TriggerEvent('es:addGroupCommand', 'itemver', 'admin', function(source, args, user)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(args[1])
	local item    = args[2]
...
TriggerEvent('es:addGroupCommand', 'disc', 'admin', function(source, args, user)
	DropPlayer(source, 'Bağlantınız kesildi') --You have been disconnected
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Yetersiz yetkiler.' } })
end)
...
TriggerEvent('es:addGroupCommand', 'cls', 'admin', function(source, args, user)
	TriggerClientEvent('chat:clear', source)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Yetersiz yetkiler.' } })
end)
...
TriggerEvent('es:addGroupCommand', 'clearinventory', 'admin', function(source, args, user)
	...
	if not xPlayer then
		TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Oyuncu çevrimiçi değil.' } })
		return
	end
